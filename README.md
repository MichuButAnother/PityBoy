# PityBoy
PityBoy is a fictional, emulated console platform written in C++, inspired by the famous GameBoy.
...
2. Install dev libs: `SFML`, `boost-filesystem`, `boost-system` and `Lua (5.4)`
